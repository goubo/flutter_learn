...
main(List<String> args) async {
  ...
  // 1. 存储所有类型的值
  await ps.setStorage('Map', {"key": "value"}); // 存储Map
  await ps.setStorage('int', 1); // 存储int
  await ps.setStorage('double', 1.0); // 存储double
  await ps.setStorage('bool', true); // 存储bool
  await ps.setStorage('String', "Hello World"); // 存储String
  await ps.setStorage('List', [1, true, 'String', 1.0]); // 存储List
